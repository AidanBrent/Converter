...
class ConversionFragmentViewModel: ViewModel() {
    ...
    //A function to be called in the UI layer, determining which tool was selected.
    ...
    //A function to be called on the UI layer, which creates a global list containing all the conversion units and their factor, relevant to the selected tool
